...
const LEGACY_WELCOME_MESSAGE = '🎉 ¡Bienvenido/a {user} al grupo! Esperamos que disfrutes tu estancia.';
const DEFAULT_WELCOME_MESSAGE = `👋 *¡BIENVENIDOS A CYBERGROUP COMMUNITY!* 🛡️💻

Nos alegra mucho tenerte aquí, {user}. Antes de comenzar, *por favor, lee las instrucciones y normas que aparecen en la descripción del grupo*. Es importante conocerlas para mantener una comunidad organizada, segura y agradable para todos.

🎯 Nuestro objetivo es que este sea un espacio donde puedas *aprender, compartir conocimientos, descubrir nuevas cosas y mejorar tus habilidades* dentro del mundo de la tecnología y la ciberseguridad.

📚 *Aprende. Comparte. Practica. Diviértete.*
🤝 Respeta a los demás miembros y aporta positivamente a la comunidad.

🚀 *¡Esperamos que aprendas mucho, hagas nuevos contactos y, sobre todo, que te diviertas!*

🔐 *CYBERGROUP COMMUNITY* — _Aprendemos juntos, crecemos juntos._`;
